<template>
    <div class="container">
      <div class="chat-wrapper">
        ...
        <div class="chat-input">
          <el-input v-model="input" @keyup="send" type="textarea" :rows="5" class="input" />
          <button class="emit-button" @click="sendInput">Enter 发送</button>
        </div>
      </div>
  
      <div class="tool" v-show="!toolShow" @click="showTools"></div>
      <!-- <Transition name="toolslists"> -->
        <ToolsMenu v-show="toolShow" @click="showTools"></ToolsMenu>
      <!-- </Transition> -->
    </div>
  </template>
  ...
  .tool {
    ...
    top: 50%;
    right: 30px;
    box-shadow: 1px 1px .9px 1px rgba(10,10,10,.5),
      -1px -1px .9px 1px rgba(210,210,210,.5);
  }
  </style>
